...
import com.example.ecommercefurniture.EcommercefurnitureApplication
...
import com.example.ecommercefurniture.util.validateEmail
        ...
        viewModelScope.launch {
            try {
                val imageBitmap = MediaStore.Images.Media.getBitmap(
                    getApplication<EcommercefurnitureApplication>().contentResolver,
                    imageUri
                )
